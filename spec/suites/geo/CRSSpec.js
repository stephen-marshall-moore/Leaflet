...
describe("Coordinate Reference Systems", function () {
	...
	let Point, LatLng, LatLngBounds, CRS, Simple, EPSG3857, EPSG4326, EPSG3395 = null;
  ...
  before(function(done) {
    ...
    System
      .import('src/geo/crs/CRS.EPSG3857')
      .then(function(t) {
          EPSG3857 = t.EPSG3857;
      })
      .catch(function(e) {
    ...
    System
      .import('src/geo/crs/CRS.EPSG4326')
      .then(function(t) {
          EPSG4326 = t.EPSG4326;
      })
      .catch(function(e) {
    ...
    System
      .import('src/geo/crs/CRS.EPSG3395')
      .then(function(t) {
          EPSG3395 = t.EPSG3395;
          done();
      })
  ...
  after(function() {
    Point, LatLng, LatLngBounds, CRS, Simple, EPSG3857, EPSG4326, EPSG3395 = null;
  });
